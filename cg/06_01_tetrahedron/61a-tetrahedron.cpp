...
const char* vertFileName = "61-set-mat4.vert";
const char* fragFileName = "61-set-mat4.frag";
...
void generateSphere(int level) {
	static glm::vec3 v[4] = {
		{ 0.0f, 0.0f, 1.0f },
		{ 0.942809f, 0.0f, -0.333333f }, // sqrt(8/9), 0, -1/3
		{ -0.471405, 0.816496f, -0.333333f }, // -sqrt(2/9), sqrt(2/3), -1/3
		{ -0.471405, -0.816496f, -0.333333f }, // -sqrt(2/9), -sqrt(2,3), -1/3
	};

#if 1
float area = glm::length(glm::cross(v[1] - v[0], v[2] - v[0]));
printf("org tri area = %f\n", area);
glm::vec3 v01 = (v[0] + v[1]) / 2.0F;
glm::vec3 v12 = (v[1] + v[2]) / 2.0F;
glm::vec3 v20 = (v[2] + v[0]) / 2.0F;
printf("v01 = %f, %f, %f\n", v01.x, v01.y, v01.z);
printf("v12 = %f, %f, %f\n", v12.x, v12.y, v12.z);
printf("v20 = %f, %f, %f\n", v20.x, v20.y, v20.z);
float area01 = glm::length(glm::cross(v01 - v[0], v20 - v[0]));
float area12 = glm::length(glm::cross(v12 - v[1], v01 - v[1]));
float area20 = glm::length(glm::cross(v20 - v[2], v12 - v[2]));
float area00 = glm::length(glm::cross(v12 - v01, v20 - v01));
printf("area 01 = %f\n", area01);
printf("area 12 = %f\n", area12);
printf("area 20 = %f\n", area20);
printf("area 00 = %f\n", area00);
printf("sum area = %f\n", area01 + area12 + area20 + area00);

v01 = glm::normalize(v01);
v12 = glm::normalize(v12);
v20 = glm::normalize(v20);
printf("v01 = %f, %f, %f\n", v01.x, v01.y, v01.z);
printf("v12 = %f, %f, %f\n", v12.x, v12.y, v12.z);
printf("v20 = %f, %f, %f\n", v20.x, v20.y, v20.z);
area01 = glm::length(glm::cross(v01 - v[0], v20 - v[0]));
area12 = glm::length(glm::cross(v12 - v[1], v01 - v[1]));
area20 = glm::length(glm::cross(v20 - v[2], v12 - v[2]));
area00 = glm::length(glm::cross(v12 - v01, v20 - v01));
printf("area 01 = %f\n", area01);
printf("area 12 = %f\n", area12);
printf("area 20 = %f\n", area20);
printf("area 00 = %f\n", area00);
