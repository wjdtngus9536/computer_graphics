...
#if 1
float area = glm::length(glm::cross(v[1] - v[0], v[4] - v[0]));
printf("org tri area = %f\n", area);
glm::vec3 v01 = (v[0] + v[1]) / 2.0F;
glm::vec3 v12 = (v[1] + v[4]) / 2.0F;
glm::vec3 v20 = (v[4] + v[0]) / 2.0F;
printf("v01 = %f, %f, %f\n", v01.x, v01.y, v01.z);
printf("v12 = %f, %f, %f\n", v12.x, v12.y, v12.z);
printf("v20 = %f, %f, %f\n", v20.x, v20.y, v20.z);
float area01 = glm::length(glm::cross(v01 - v[0], v20 - v[0]));
float area12 = glm::length(glm::cross(v12 - v[1], v01 - v[1]));
float area20 = glm::length(glm::cross(v20 - v[4], v12 - v[4]));
...
area20 = glm::length(glm::cross(v20 - v[4], v12 - v[4]));
