...
const char* vertFileName = "61-vert-phong.vert";
const char* fragFileName = "61-vert-phong.frag";
...
void setLnM(void) {
	GLfloat light_pos[4] = { -3.0f, 3.0f, 3.0f, 1.0f };
	GLfloat light_amb[4] = { 0.2f, 0.2f, 0.2f, 1.0f };
	GLfloat light_dif[4] = { 4.0f, 4.0f, 4.0f, 1.0f };
	GLfloat light_spe[4] = { 7.0f, 7.0f, 7.0f, 1.0f };
	GLfloat light_att[4] = { 1.0f, 0.2f, 0.2f, 1.0f }; // a, b, c, dummy
	GLfloat mat_amb[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	GLfloat mat_dif[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	GLfloat mat_spe[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	GLfloat mat_shi = 32.0f; // shineness
	GLuint loc;
	// light
