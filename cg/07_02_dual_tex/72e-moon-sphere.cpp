...
const char* vertFileName = "72-tex-sphere.vert";
const char* fragFileName = "72-tex-sphere.frag";
...
void drawFunc(void) {
	...
	glVertexAttribPointer(locTexCoord, 2, GL_FLOAT, GL_FALSE, 0, glm::value_ptr(texCoordSphere[0]));
