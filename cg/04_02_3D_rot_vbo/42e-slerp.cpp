...
glm::quat q0 = glm::angleAxis( (float)M_PI_2 / 2.0F, glm::vec3( 1, 0, 0) );
glm::quat q1 = glm::angleAxis( (float)M_PI_2 / 2.0F, glm::vec3( 0, 0, 1) );
...
void updateFunc(void) {
	...
	float t = (elapsedTimeMSEC.count() % 1000) / 1000.0F;
