...
const char* vertFileName = "53-mvp.vert";
const char* fragFileName = "53-mvp.frag";
...
void updateFunc(void) {
	...
	matCube = glm::translate(matCube, glm::vec3(0.0F, y, 0.0F));
	...
	matView = glm::lookAtRH(
		glm::vec3(radius * sinf(theta), 5 * 0.05F, radius * cosf(theta)),
