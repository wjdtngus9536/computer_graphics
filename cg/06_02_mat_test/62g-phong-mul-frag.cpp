...
const char* vertFileName = "62-phong-mul-frag.vert";
const char* fragFileName = "62-phong-mul-frag.frag";
...
void setLnM(void) {
	...
	glUniform4fv(loc, 1, glm::value_ptr(light[0].pos));
	loc = glGetUniformLocation(prog, "light[0].ambient");
	glUniform4fv(loc, 1, glm::value_ptr(light[0].ambient));
	loc = glGetUniformLocation(prog, "light[0].diffuse");
	glUniform4fv(loc, 1, glm::value_ptr(light[0].diffuse));
	loc = glGetUniformLocation(prog, "light[0].specular");
	glUniform4fv(loc, 1, glm::value_ptr(light[0].specular));
	loc = glGetUniformLocation(prog, "light[0].att");
	glUniform4fv(loc, 1, glm::value_ptr(light[0].att));
	// light[1]
	loc = glGetUniformLocation(prog, "light[1].pos");
	glUniform4fv(loc, 1, glm::value_ptr(light[1].pos));
	loc = glGetUniformLocation(prog, "light[1].ambient");
	glUniform4fv(loc, 1, glm::value_ptr(light[1].ambient));
	loc = glGetUniformLocation(prog, "light[1].diffuse");
	glUniform4fv(loc, 1, glm::value_ptr(light[1].diffuse));
	loc = glGetUniformLocation(prog, "light[1].specular");
	glUniform4fv(loc, 1, glm::value_ptr(light[1].specular));
	loc = glGetUniformLocation(prog, "light[1].att");
	glUniform4fv(loc, 1, glm::value_ptr(light[1].att));
	// material
